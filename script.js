...
function renderResult(score, payload, backendRecommendations) {
  ...
  // =====================================================
  // LLM RECOMMENDATIONS FROM FASTAPI / MISTRAL
  // =====================================================

  console.log("LLM recommendations received:", backendRecommendations);
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      console.log("LLM RECOMMENDATIONS:", data.recommendations);
